...
<head>
  <meta charset="<?=$pr['ISO88591'];?>">
    <title><?=$pr['SITE_NOME'];?> - Editar Destaque</title>
...
<div class="content-box-header">
	<h3 style="cursor: s-resize; ">Editar Destaque</h3>
	<a href="javascript:history.go(-1)" class="btnvoltar" title=" Voltar para Lista ">Voltar para Lista</a>
	<div class="clear"></div>

<?php 
$sql = mysql_query("SELECT * FROM cliente WHERE id='$id'") or die(mysql_error());
...
//					echo $erro . "<br />";
		...
		///////////////////////////////////////////////////
			...
			$sql_query_update = "UPDATE cliente SET nome='$nome', mensagem='$mensagem', imagem='$foto', data_criacao=NOW() WHERE id='$id'";
...
<div>
<p></p>
<form action="clienteE.php?acao=update&id=<?=$id;?>" method="post" enctype="multipart/form-data">
		...
		<label>Mensagem:</label>
			<p><span id="counted" style="color:red;"></span></p>
			<p><span id="instructions">(Texto com um mínimo de 50 caracteres.)</span></p>
 			<textarea onKeyUp="wordcounter(this); document.getElementById('instructions').style.display='none'" onFocus="wordcounter(this); document.getElementById('instructions').style.display='none'" wrap="virtual" class="text-input textarea" id="textarea" name="mensagem" cols="79" rows="5"><?=$mensagem;?></textarea>
		<p></p>
					
		<div class="align-left">
			<label>Imagem: <br /><strong>(60x60)</strong></label>
			<span class="alignverticaltop">
				<a href="../images/clientes/<?=$foto;?>" id="fancyimg"><img src="../images/clientes/<?=$foto;?>" width="95" class="borda"></a>
			</span>
			<p>&nbsp;</p>
				<label class="cabinet">
					...
					<div class="clear"></div>
					<p>&nbsp;</p>
					<input class="button" type="submit" value=" Alterar Destaque ">
		</form>
