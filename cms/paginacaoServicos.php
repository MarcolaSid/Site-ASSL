<?
 $pagina = $_GET["pagina"];
 $sql = mysql_query("SELECT * FROM servicos") or die(mysql_error());
 $Qtde = 4;
 ...
 $inicio = $limit * $Qtde;
 $sql = mysql_query("SELECT * FROM servicos ORDER BY id DESC Limit $inicio, $quantidade") or die(mysql_error());  
