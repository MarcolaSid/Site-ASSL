<?
 $pagina = $_GET["pagina"];
 $sql = mysql_query("SELECT * FROM produto WHERE nome LIKE '%".$palavra."%' ORDER BY nome DESC ") or die(mysql_error());
 $Qtde = 4;
 ...
 $inicio = $limit * $Qtde;
 $sql = mysql_query("SELECT * FROM produto WHERE nome LIKE '%".$palavra."%' ORDER BY nome DESC Limit $inicio, $quantidade") or die(mysql_error());  
