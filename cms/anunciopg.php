<?
 $pagina = $_GET["pagina"];
 $sql = mysql_query("SELECT * FROM anuncios") or die(mysql_error());
 $Qtde = 10;
 ...
 $inicio = $limit * $Qtde;
 $sql = mysql_query("SELECT * FROM anuncios ORDER BY id DESC Limit $inicio, $quantidade") or die(mysql_error());  
