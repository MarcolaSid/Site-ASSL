...
<head>
  <meta charset="<?=$pr['ISO88591'];?>">
    <title><?=$pr['SITE_NOME'];?> - Destaques página principal</title>
...
<div class="content-box-header">
	<h3 style="cursor: s-resize; ">Visualizar Destaques</h3>
	<div class="clear"></div>
...
{ 	
	...
	$res = mysql_query("DELETE FROM cliente WHERE id = '$id' ")or die(mysql_error()); 
	if ($login) 
	{
?>
...
<?php
	...
	$query_rsFotos 				= "SELECT * FROM cliente ORDER BY id DESC LIMIT $inicio, $quantidade";
...
<ul>
<?php
$sql = mysql_query("SELECT * FROM cliente ORDER BY id ASC Limit $inicio, $quantidade ") or die(mysql_error());
...
<li style="margin:0 5px 20px 0;width: 150px!important;height: 150px;clear: right;float: left;">
	<span class="iconesclientes">
		<a href="./clienteE.php?id=<?=$idp;?>" title="Editar"><img src="./img/icones/pencil.png" alt="Editar"></a>
		<a href="./clienteV.php?acao=exclui&id=<?=$idp;?>" title="Excluir">&nbsp;&nbsp;<img src="./img/icones/cross.png" alt="Excluir"></a><br />
	</span>
		<a href="../images/clientes/<?=$imagemp;?>" id="fancyimg"><img src="../images/clientes/<?=$imagemp;?>" width="95" height="90" class="borda" style="padding:8px;background:#fefefe;"></a><br />
		<?=utf8_decode($nomep);?>
</li>
<?php } ?>
</ul>
