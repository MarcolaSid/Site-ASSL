...
<head>
  <meta charset="<?=$pr['ISO88591'];?>">
    <title><?=$pr['SITE_NOME'];?> - Editar Item da Galeria</title>
...
<div class="content-box-header">
	<h3 style="cursor: s-resize; ">Editar Item da Galeria</h3>
	<a href="javascript:history.go(-1)" class="btnvoltar" title=" Voltar para Lista ">Voltar para Lista</a>
	<div class="clear"></div>

<?php 
$sql = mysql_query("SELECT * FROM galeria WHERE id='$id'") or die(mysql_error());
...
//					echo $erro . "<br />";
		...
		///////////////////////////////////////////////////
			...
			$sql_query_update = "UPDATE galeria SET nome='$nome', imagem='$foto', data_criacao=NOW() WHERE id='$id'";
...
<div>
<p></p>
<form action="galeriaE.php?acao=update&id=<?=$id;?>" method="post" enctype="multipart/form-data">
		...
		<div class="align-left">
			<label>Imagem: <br /><strong>(650x427)</strong></label>
			<span class="alignverticaltop">
				<a href="../images/galeria/<?=$foto;?>" id="fancyimg"><img src="../images/galeria/<?=$foto;?>" width="100" class="borda"></a>
			</span>
			<p>&nbsp;</p>
				<label class="cabinet">
					...
					<div class="clear"></div>
					<p>&nbsp;</p>
					<input class="button" type="submit" value=" Alterar Item da Galeria ">
		</form>
