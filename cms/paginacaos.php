<?
 $pagina = $_GET["pagina"];
 $sql = mysql_query("SELECT * FROM subcategoria") or die(mysql_error());
 $Qtde = 5;
 ...
 $inicio = $limit * $Qtde;
 $sql = mysql_query("SELECT * FROM subcategoria ORDER BY nome DESC Limit $inicio, $quantidade") or die(mysql_error());  
