...
<head>
  <meta charset="<?=$pr['ISO88591'];?>">
    <title><?=$pr['SITE_NOME'];?> - Emails Ativos</title>
	...
	<tbody>
		...
		<tr>		
			<td>
				<ul class="align-left">
					<li>
						<h4>Lista de Emails Ativos</h4>
						<?php
							$result = mysql_query("SELECT id, email, status FROM cadastro WHERE status = 'ativo' ORDER BY status ASC");
