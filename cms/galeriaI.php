...
<head>
  <meta charset="<?=$pr['ISO88591'];?>">
    <title><?=$pr['SITE_NOME'];?> - Cadastro de Item da Galeria</title>
...
<div class="content-box-header">
	<h3 style="cursor: s-resize; ">Cadastro de Item da Galeria</h3>
	<div class="clear"></div>
<?php
	if ($_GET['acao'] == "insere")
	{ 
...
//					echo $erro . "<br />";
	...
	$sql = "INSERT INTO galeria (nome, imagem, data_criacao)
					VALUES ('$nome', '$foto', NOW())";
...
<form name="insere" action="galeriaI.php?acao=insere" method="post" enctype="multipart/form-data">
  	<label>Nome:</label>
	...
	<div class="clear"></div>
	<p>&nbsp;</p>
	<input class="button" type="submit" value=" Cadastrar Item da Galeria ">
</form>
</div>
